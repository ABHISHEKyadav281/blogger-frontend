...
const CreatePost: React.FC = () => {
  ...
  const handleSave = async (status: 'DRAFT' | 'PUBLISHED' = 'DRAFT') => {
    ...
    try {
      ...
      const response = await api.post("/post/v1/createPost", dataToSend);
...
//   Trash2,
// } from 'lucide-react';
// import RichTextEditor from '../component/createPost/RichTextEditor';
// import MediaUpload from '../component/createPost/MediaUpload';
// import PostPreview from '../component/createPost/PostPreview';
